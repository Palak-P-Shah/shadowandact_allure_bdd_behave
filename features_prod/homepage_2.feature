Feature: Home Page Verification for ShadowAndAct.com for latest and sign up sections
 
  Scenario: Verify the different sections of the Home Page for website ShadowAndAct.com for latest and sign up sections
