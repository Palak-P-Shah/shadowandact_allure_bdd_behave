Feature: Home Page Verification for ShadowAndAct.com for navigation links, carousel and most popular sections
 
  Scenario: Verify the different sections of the Home Page for ShadowAndAct.com for navigation links, carousel and most popular sections
